      ...
      <section className="depoimentosHome py-16">
        <div className="innerWidth max-w-8xl flex flex-col items-center justify-center gap-16 px-4 mx-auto">
          <div className="depoimentoContainer w-full bg-tertiary flex flex-col items-center justify-center gap-12 rounded-3xl max-md:gap-8 max-md:p-8 p-16">
            <p className="max-md:text-2xl font-caveat text-secondary text-3xl leading-[1.25]">“Como fundador da ONG Repense, sinto um imenso orgulho por tudo o que conquistamos até aqui. Cada desafio superado fortaleceu ainda mais nosso propósito de gerar um impacto positivo na vida das pessoas. Mas, na verdade, acredito que os maiores beneficiados somos nós, que trabalhamos nesse projeto — ou em qualquer iniciativa que coloca o outro no centro.<br/><br/>Para mim, essa tem sido uma experiência transformadora, não apenas no aspecto pessoal, mas também profissional. Aprendi que, além dos desafios técnicos, o verdadeiro diferencial está nas pessoas. E isso me fez evoluir como profissional, ampliando minha visão sobre o que realmente importa na construção de soluções que fazem a diferença.”</p>
